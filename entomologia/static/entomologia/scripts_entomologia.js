...
document.addEventListener("DOMContentLoaded", function(){
  var wrapper = document.getElementById("visitCounterWrapper");
  var button = document.getElementById("visitorButton");

  // Ao clicar no botão, a classe "active" é alternada no container, mostrando ou ocultando o rótulo à esquerda
